...
Original file is located at
    https://colab.research.google.com/drive/134cqTunKGc0aVIURwoASFuWEz_U-yD0w
"""
...
df_data = pd.read_csv('/content/dataset/HAM10000_metadata.csv')
df_data.head()
...
folder_1 = os.listdir('/content/dataset/ham10000_images_part_1')
folder_2 = os.listdir('/content/dataset/ham10000_images_part_2')
...
for image in train_list:
    ...
    if fname in folder_1:
        ...
        src = os.path.join('/content/dataset/ham10000_images_part_1', fname)
    ...
    if fname in folder_2:
        # source path to image
        src = os.path.join('/content/dataset/ham10000_images_part_2', fname)
        # destination path to image
        dst = os.path.join(train_dir, label, fname)
        # copy the image from the source to the destination
        shutil.copyfile(src, dst)
...
"""Evaluate the model using val set"""
